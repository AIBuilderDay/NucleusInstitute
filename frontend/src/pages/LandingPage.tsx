...
function signInWithGoogle() {
  window.location.href = `${API_BASE_URL}${API_PREFIX}/auth/google/login`;
}
      ...
      <section className="max-w-[1240px] mx-auto px-32 pt-80 pb-96 grid grid-cols-[repeat(auto-fit,minmax(420px,1fr))] gap-64 items-center">
        <div className="min-w-0">
          ...
          <div className="flex gap-12 flex-wrap">
            ...
            <button
              className="btn btn-ghost px-24 py-14 text-[15px] h-48 inline-flex items-center gap-10 bg-white border border-pearl-300"
